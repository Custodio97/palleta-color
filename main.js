class Colour{
    ...
    copyToClipboard() {
        const input = document.querySelector(".colour-input")
        input.select()
...
const colours_elements = document.querySelectorAll(".colours .colour")
const colours = []

for (let i = 0; i < colours_elements.length;i++){
    const colour_element = colours_elements[i]
    ...
    lock_toggle.addEventListener("click", () => colour.setToggleLocked())
